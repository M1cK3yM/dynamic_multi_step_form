...
class DynamicForm extends StatefulWidget {
  ...
  final Function(
      ...
      bool? isBack})? currentStepCallBack;
  ...
  const DynamicForm(this.jsonEncoded,
      ...
      this.selectedColor = const Color(0xFF3BAD59),
      this.unselectedColor = const Color(0xFFC2C2C2),
  ...
  DynamicFormState createState() => DynamicFormState(
      jsonEncoded: jsonEncoded, titleTextStyle: titleTextStyle);
}
...
class DynamicFormState extends State<DynamicForm> {
  ...
  DynamicFormState(
    ...
    formScreen = formScreenList.entries.map((entry) {
      ...
      if (this.formSubmitData.isNotEmpty &&
          this.formSubmitData.containsKey('$currentIndex')) {
...
// Check if _formSubmitFinalData contains the key and if its value is not null or empty
        if (_formSubmitFinalData.containsKey('$currentPageIndex') &&
          ...
          Map<String, dynamic> formSubmitFinalSingleData =
              _formSubmitFinalData["$currentPageIndex"] as Map<String, dynamic>;
          ...
          Map<String, dynamic>? data = formScreen[currentPage]
              .singleFormKey!
              .currentState!
              .getFormData();
          Map<String, dynamic>? formInformation = formScreen[currentPage]
        ...
        ? (count > 1
            ? Padding(
                ...
                child: StepProgressIndicator(
                    ...
                    unselectedColor: widget.unselectedColor ?? unselectedColor,
                    onTap: (index) {
                      return () {
